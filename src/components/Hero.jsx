...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center text-center overflow-hidden px-4 sm:px-6"
    >
      {/* Background Video */}
      <video
        autoPlay
      ...
      <div className="relative z-10 max-w-4xl w-full">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl 
                       font-bold text-white leading-tight mb-6 px-2">
          Personalized Skin & Hair Intelligence
        </h1>

        {/* Description */}
        <p className="text-gray-300 text-base sm:text-lg md:text-xl 
                      max-w-2xl mx-auto mb-8 px-2">
          We’re building the world’s first ecosystem that scans your skin with AI,
          recommends what truly works, and rewards you with tokens you can use 
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <Link
            ...
            className="w-full sm:w-auto px-6 py-3 rounded-lg text-white font-semibold
