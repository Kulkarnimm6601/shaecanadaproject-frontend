    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <h2 className="text-green-950 text-3xl md:text-5xl  mb-6 text-green-700">
        For Brands
      </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* AI Discoverability */}
          <div className="bg-white p-8 rounded-2xl  hover:border-green-400 hover:shadow-lg transition duration-300 text-center">
            <img src={s} alt="AI Discoverability" className="h-20 w-20 mx-auto mb-4" />
            <h3 className="text-green-950 text-xl font-semibold mb-2 text-green-800">
              AI Discoverability
            </h3>
        ...
        <div className="mt-24 text-center">
          <Link to="/apply-to-join-shae-marketplace" className="inline-block bg-white border border-gray-200 px-6 py-3 rounded-full text-green-950 font-semibold hover:bg-green-50 hover:scale-105 transition duration-300 shadow-sm">
